...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid-bg radial-gradient-bg relative overflow-hidden flex items-center justify-center" style={{ background: 'var(--bg-primary)' }}>
        ...
        <div className="glass-panel p-8">
          ...
          >
            <div className="flex justify-center mb-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--accent-primary)] to-[var(--accent-secondary)] flex items-center justify-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full cyber-button-primary flex items-center justify-center gap-2 py-3 disabled:opacity-70"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
